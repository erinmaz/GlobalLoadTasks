...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.75.01), Thu Jul 23 09:56:22 2015
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/erin/Dropbox/Tasks/GlobalLoad/motor_builder_56s_off_4blocks_40s.psyexp',
...
instructions = visual.TextStim(win=win, ori=0, name='instructions',
    text="Stay as still as possible\n\nKeep your eyes on the red '+'  \n\nWhen it changes to green, start tapping with both hands.\n\nWhen it turns red, stop tapping.",    font='Arial',
...
WaitForTriggerComponents.append(key_resp_2)
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    elif text.status == STARTED and t >= (0.0 + (56-win.monitorFramePeriod*0.75)): #most of one frame period left
...
trials_2 = data.TrialHandler(nReps=3, method=u'sequential', 
    extraInfo=expInfo, originPath=u'/Users/erin/Dropbox/Tasks/GlobalLoad/motor_builder_56s_off_4blocks_40s.psyexp',
    trialList=[None],
...
for thisTrial_2 in trials_2:
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        elif text_2.status == STARTED and t >= (0.0 + (40-win.monitorFramePeriod*0.75)): #most of one frame period left
